const Pictures: any = {
  ...
  horsey1: require("../data/png/horsey1.png"),
  horsey2: require("../data/png/horsey2.png"),
  horsey3: require("../data/png/horsey3.png"),
  horsey4: require("../data/png/horsey4.png"),
  horsey5: require("../data/png/horsey5.png"),
  horsey6: require("../data/png/horsey6.png"),
